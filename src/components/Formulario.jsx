...
const Formulario = ({ addAlert, informacion, setArchivo, dataFileFilter, setDataFileFilter }) => {
  ...
  function addEmployee(event) {
    ...
    switch(true) {
        ...
        default:
            ...
            const newId = informacion.length ? (parseInt(informacion[informacion.length - 1].id) + 1).toString() : '0';

            setArchivo([...informacion, { id: newId, ...employeeData }]);
